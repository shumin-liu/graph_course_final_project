...
#hdi_10_line_chart = hdi_10_line_chart.add_annotation(
...
## Row 1.1 - Map & Text box {height=55%}
...
## Row 1.2 - Line chart & Table {height=45%}
...
### Column 2.1.1 {width="70%"}
```{python}
gdp_pcap_avg_bar
```

### Column 2.1.2 {width="30%"}
::: {.card}
#### Insights for page 2
Provide a description here.
:::
